...
// ─── Wrapper pre-configurado con el tema NCAA Masculino ───────────────────────
// Las tablas específicas de este módulo importan TableBase desde este archivo
// y obtienen el tema automáticamente sin necesidad de conocer colors.ts

export function TableBase<T>(props: Omit<TableBaseProps<T>, "theme">) {
  return (
    <SharedTableBase
      {...props}
      theme={sportThemes.ncaaMale}
    />
  );
}
...
// ─── TableParticipants — tabla principal de la home ───────────────────────────
